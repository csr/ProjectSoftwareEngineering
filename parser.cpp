...
void parser::set_values_station(string elemName, Station station, string attributeValue){
    if(elemName == "track")
        ...
        cout << "attributeName2 " << station.getName() << endl;
    }
...
void parser::check_digits_letters_station(string elemName, string attributeValue, Station station){
    int i = 0;
    bool is_ok = true;
    if(elemName == "name"){
        if(attributeValue.length() > 0) {
            cout << "1 " << endl;
            is_ok = check_letter(attributeValue, i,
                                 is_ok); // it is false if the string contains not letters or it is ""else
        }
        else
...
void parser::check_digits_letters_tram(string elemName, string attributeValue, Tram tram){
    int i = 0;
    bool is_ok = true;
    ...
    for (TiXmlElement *root = doc.FirstChildElement(); root != NULL; root = root->NextSiblingElement()) {
        ...
        if (rootName != "STATION" && rootName != "TRAM") {
            ...
            if (elem_name == NULL) {
                ...
                if (name != "") {
                    check_digits_letters_station(name_string, name,
                                                 *station); // * per prendere il valore puntato dal puntatore station
            ...
            if (elem_previous == NULL) {
                ...
                /*if (previous != "")
                    check_digits_letters_station(previous_string, previous, *station);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }*/
            ...
            if (elem_next == NULL) {
                ...
                /*if (next != "")
                    check_digits_letters_station(next_string, next, *station);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }*/
            ...
            if (elem_track == NULL) {
                ...
                /*if (track != "")
                    check_digits_letters_station(track_string, track, *station);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }*/
            ...
            if (elem_line == NULL) {
                ...
                if (line != "")
                    check_digits_letters_tram(line_string, line, *tram);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }
            ...
            if (elem_capacity == NULL) {
                ...
                if (capacity != "")
                    check_digits_letters_tram(capacity_string, capacity, *tram);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }
            ...
            if (elem_speed == NULL) {
                ...
                if (speed != "")
                    check_digits_letters_tram(speed_string, speed, *tram);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }
            ...
            if (elem_startStation == NULL) {
                ...
                if (startStation != "")
                    check_digits_letters_tram(startStation_string, startStation, *tram);
                else {
                    cout << "INVALID DATA FOR ATTRIBUTE" << endl;
                    endResult = 1;
                }
